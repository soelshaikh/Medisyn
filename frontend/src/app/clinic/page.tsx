...
const STATUS_COPY: Record<string, { icon: typeof Clock3; title: string; body: string }> = {
  pending_verification: {
    ...
    body: "Please check your inbox and click the verification link to continue your clinic application.",
  },
  pending_approval: {
    icon: Clock3,
    title: "Application under review",
    body: "Thanks for verifying your email. A MediSyn administrator is reviewing your clinic application — you'll be notified by email once a decision is made.",
  },
  rejected: {
    icon: XCircle,
    title: "Application not approved",
    body: "Unfortunately your clinic application was not approved at this time. Contact MediSyn support for more information.",
  },
  suspended: {
    icon: Ban,
    title: "Account suspended",
    body: "Your clinic account has been temporarily suspended. Contact MediSyn support for assistance.",
  },
  deactivated: {
    icon: Ban,
    title: "Account deactivated",
    body: "Your clinic account is deactivated. Contact MediSyn support for assistance.",
  },
};
